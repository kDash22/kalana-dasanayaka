...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "kalanadasanayaka.work@gmail.com",
    href: "mailto:kalanadasanayaka.work@gmail.com",
  },
  {
    icon: MapPin,
    label: "Location",
...
const EmailJs = {
  serviceId: "service_qjx540w",
  templateId: "template_poceu3s",
  publicKey: "saAGfExbJs3iLQGHO",
};
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!EmailJs.serviceId || !EmailJs.templateId || !EmailJs.publicKey) {
        throw new Error("EmailJS configurations is missing. !");
      }
